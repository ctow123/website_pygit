...
# creates a dictionary data["names"] and data["encodings"]
# print(data["encodings"])
# load the input image and convert it from BGR to RGB and resize
...
# loop over the recognized faces , change resize to image to draw bounding boxes on that image
...
# save image to file
filepath = os.getcwd()
name = os.path.splitext(imagename)[0] + "ML" + os.path.splitext(imagename)[1]
cv2.imwrite(name, resize)
# cv2.waitKey(0)

# improvements
# line 75- draw additional text
# by building a dictionary using name as key and have additional values.
#
